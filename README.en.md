...
| Data qualification | Request-scoped `research_only / retrospective_reference / strict_pit / official_rule_covered`; sparse eligibility statements or caller-provided booleans cannot certify a complete universe, and missing exact-session receipts fail closed |
