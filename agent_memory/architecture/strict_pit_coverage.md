...
- 当前 `/Volumes/Lexar/niuniu-data` 已有 `security_status=14` verified sparse statements（7只股票），其它三类 statement、PIT Universe v1 与 SecurityStatus v2 完整逐日 snapshot 均为0；历史 bars 很多不改变覆盖不完整这一事实。
