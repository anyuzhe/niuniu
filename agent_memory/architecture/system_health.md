...
- PIT/Playbook 组件对 PIT Universe v1、SecurityStatus v2 与 Official MarketRules v2 做全局 receipt/records/官方原文字节完整性审计；invalid receipt、SecurityStatus中的UNKNOWN、同session歧义或previous链分叉必须 WARN，不能被当成空库。该 inventory 不是最新 CandidateSet 的 case-specific snapshot/coverage 证明。
