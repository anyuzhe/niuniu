...
class LimitResearchToolTests(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        ids = build_research_workspace(cls.output)
        cls.events, cls.sentiment, cls.study_id = ids['events'], ids['sentiment'], ids['study_id']
        cls.api = LimitResearchAPI(ReadOnlyResearchAPI(cls.output))
