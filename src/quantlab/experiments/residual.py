...
def run_residual(candidate_path,control_paths,train_end,output,horizon=1):
    ...
    run_id=str(uuid4());record={'run_id':run_id,'experiment_id':digest(manifest),'status':'completed','kind':'residual_alpha',
