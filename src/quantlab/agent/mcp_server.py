...
def build_mcp_api(output,data_root=None,*,rights_candidate_binding=None,rights_evidence_binding=None):
...
def build_mcp_server(output,data_root=None,*,rights_candidate_binding=None,rights_evidence_binding=None):
    output=resolve_research_output(output)
...
def run_mcp(output,data_root=None,transport='stdio',host='127.0.0.1',port=8766,*,rights_candidate_binding=None,rights_evidence_binding=None):
...
def main():
    ...
    run_mcp(args.output,args.data_root,args.transport,args.host,args.port,rights_candidate_binding=binding,
        rights_evidence_binding=evidence_binding)
