...
from quantlab._vendor.chanpy.Common.CEnum import DATA_FIELD, TRADE_INFO_LST, TREND_TYPE
...
from quantlab._vendor.chanpy.Math.BOLL import BOLL_Metric, BollModel
from quantlab._vendor.chanpy.Math.Demark import CDemarkEngine, CDemarkIndex
from quantlab._vendor.chanpy.Math.KDJ import KDJ
from quantlab._vendor.chanpy.Math.MACD import CMACD, CMACD_item
...
class CKLine_Unit:
    def __init__(self, kl_dict, autofix=False):
        ...
        from quantlab._vendor.chanpy.KLine.KLine import CKLine
