...
from quantlab._vendor.chanpy.Bi.BiList import CBiList
from quantlab._vendor.chanpy.BuySellPoint.BSPointList import CBSPointList
from quantlab._vendor.chanpy.ChanConfig import CChanConfig
from quantlab._vendor.chanpy.Common.CEnum import KLINE_DIR, SEG_TYPE
...
from quantlab._vendor.chanpy.Seg.SegListComm import CSegListComm
from quantlab._vendor.chanpy.ZS.ZSList import CZSList
...
def get_seglist_instance(seg_config: CSegConfig, lv) -> CSegListComm:
    if seg_config.seg_algo == "chan":
        from quantlab._vendor.chanpy.Seg.SegListChan import CSegListChan
        ...
        from quantlab._vendor.chanpy.Seg.SegListDYH import CSegListDYH
        return CSegListDYH(seg_config, lv)
    elif seg_config.seg_algo == "break":
        print(f'Please avoid using seg_algo={seg_config.seg_algo} as it is deprecated and no longer maintained.')
        from quantlab._vendor.chanpy.Seg.SegListDef import CSegListDef
