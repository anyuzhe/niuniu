...
ORDER=('workspace','artifact_growth','jobs','approval_input_freezes','tracking_daemon','mcp','notifications','market_data_series','daily_market','market_snapshots','market_snapshot_provider','daily_orchestrator','pit_playbook','paper_lifecycle','broker_shadow','real_trade_readiness','dev_studio','logs')
LABELS={'workspace':'工作空间','artifact_growth':'产物增长','jobs':'研究任务','approval_input_freezes':'Approval Input Freeze','tracking_daemon':'Tracking Daemon','mcp':'MCP',
